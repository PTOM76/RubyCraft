...
public class CrushingMachine extends BlockWithEntity {
    ...
    public static Block newBlock() {
        return new CrushingMachine(getSettings());
    }

    @Override
    public BlockEntity createBlockEntity(BlockView world) {
        return new CrushingMachineEntity();
    }
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof CrushingMachineEntity) {
                ItemScatterer.spawn(world, pos, (CrushingMachineEntity) blockEntity);
