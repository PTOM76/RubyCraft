...
public class Items {
    public static Item RUBY = Ruby.newItem();
    public static Item RUBY_BLOCK = RubyBlock.newItem();
    public static Item RUBY_BLOCK_V2 = RubyBlockV2.newItem();
    public static Item RUBY_ORE = RubyOre.newItem();
    public static Item RUBY_DUST = RubyDust.newItem();
    ...
    public static Item RUBY_PICKAXE = RubyPickaxe.newItem();
    public static Item RUBY_SHOVEL = RubyShovel.newItem();
    public static Item RUBY_HOE = RubyHoe.newItem();
    public static Item RUBY_HELMET = RubyHelmet.newItem();
